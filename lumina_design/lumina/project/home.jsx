  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", overflow: "hidden", paddingTop: 90 }}>
      ...
      <div style={{ position: "absolute", inset: 0, transform: `translateY(${p * 0.25}px) scale(1.05)`, zIndex: 0 }}>
        <div className="th-santorini" style={{ position: "absolute", inset: 0 }} />
        ...
        <div style={{ position: "absolute", inset: 0, backgroundImage: "repeating-linear-gradient(135deg, oklch(1 0 0 / 0.04) 0 2px, transparent 2px 11px)" }} />
        <span style={{ position: "absolute", right: 30, bottom: 250, fontFamily: "ui-monospace, monospace", fontSize: 11, color: "oklch(1 0 0 / 0.6)", background: "oklch(0.2 0.03 235 / 0.3)", padding: "3px 8px", borderRadius: 6 }}>hero · aegean coastline at golden hour</span>
      </div>
        ...
        <div className="dest-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gridAutoRows: "200px", gap: 16 }}>
          {tiles.map((d, i) => (
            <button key={d.name + i} className="reveal" onClick={() => go({ view: "listing", q: d.name })}
              ...
              onMouseEnter={(e) => e.currentTarget.querySelector(".ph").style.transform = "scale(1.08)"}
